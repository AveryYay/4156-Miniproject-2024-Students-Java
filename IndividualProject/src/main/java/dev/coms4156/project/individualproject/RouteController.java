...
public class RouteController {
  ...
  public static final String DEPT_CODE_PARAM = "deptCode";
  public static final String ATTRIBUTE_UPDATE_SUCCESS = "Attribute was updated successfully.";
  ...
  public ResponseEntity<?> retrieveDepartment(@RequestParam(value = DEPT_CODE_PARAM)
                                                String deptCode) {
    try {
  ...
  public ResponseEntity<?> retrieveCourse(@RequestParam(value = DEPT_CODE_PARAM) String deptCode,
                                          @RequestParam(value = COURSE_CODE_PARAM) int courseCode) {
    try {
  ...
  public ResponseEntity<?> isCourseFull(@RequestParam(value = DEPT_CODE_PARAM) String deptCode,
                                        @RequestParam(value = COURSE_CODE_PARAM) int courseCode) {
    try {
  ...
  public ResponseEntity<?> getMajorCtFromDept(@RequestParam(value = DEPT_CODE_PARAM)
                                                String deptCode) {
    try {
      boolean doesDepartmentExists = retrieveDepartment(deptCode).getStatusCode() == HttpStatus.OK;
      if (doesDepartmentExists) {
  ...
  public ResponseEntity<?> identifyDeptChair(@RequestParam(value = DEPT_CODE_PARAM)
                                               String deptCode) {
    try {
      boolean doesDepartmentExists = retrieveDepartment(deptCode).getStatusCode() == HttpStatus.OK;
      if (doesDepartmentExists) {
  ...
  public ResponseEntity<?> findCourseLocation(@RequestParam(value = DEPT_CODE_PARAM)
                                                String deptCode,
                                              @RequestParam(value = COURSE_CODE_PARAM)
                                              int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> findCourseInstructor(@RequestParam(value = DEPT_CODE_PARAM)
                                                  String deptCode,
                                                @RequestParam(value = COURSE_CODE_PARAM)
                                                int courseCode) {
    try {
  ...
  public ResponseEntity<?> findCourseTime(@RequestParam(value = DEPT_CODE_PARAM) String deptCode,
                                          @RequestParam(value = COURSE_CODE_PARAM)
                                          int courseCode) {
    try {
      boolean doesCourseExists;
  ...
  public ResponseEntity<?> addMajorToDept(@RequestParam(value = DEPT_CODE_PARAM) String deptCode) {
    try {
      boolean doesDepartmentExists = retrieveDepartment(deptCode).getStatusCode() == HttpStatus.OK;
      if (doesDepartmentExists) {
        HashMap<String, Department> departmentMapping;
  ...
  public ResponseEntity<?> removeMajorFromDept(@RequestParam(value = DEPT_CODE_PARAM)
                                                 String deptCode) {
    try {
      boolean doesDepartmentExists = retrieveDepartment(deptCode).getStatusCode() == HttpStatus.OK;
      if (doesDepartmentExists) {
  ...
  public ResponseEntity<?> dropStudent(@RequestParam(value = DEPT_CODE_PARAM) String deptCode,
                                       @RequestParam(value = COURSE_CODE_PARAM)
                                       int courseCode) {
    try {
      boolean doesCourseExists;
  ...
  /**
   * Attempts to set the enrollment count for a specified course in a department.
   *
   ...
   * @param count          the new enrollment count to be set for the course
   *
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam(value = DEPT_CODE_PARAM)
                                                String deptCode,
                                              @RequestParam(value = COURSE_CODE_PARAM)
                                                int courseCode,
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam(value = DEPT_CODE_PARAM)
                                              String deptCode,
                                            @RequestParam(value = COURSE_CODE_PARAM)
                                              int courseCode,
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam(value = DEPT_CODE_PARAM)
                                                 String deptCode,
                                               @RequestParam(value = COURSE_CODE_PARAM)
                                                int courseCode,
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam(value = DEPT_CODE_PARAM)
                                                  String deptCode,
                                                @RequestParam(value = COURSE_CODE_PARAM)
                                                  int courseCode,
