...
public class RouteController {
  ...
  public ResponseEntity<?> findCourseLocation(@RequestParam(value = "deptCode")
                                                String deptCode,
                                              @RequestParam(value = "courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam(value = "deptCode")
                                                String deptCode,
                                              @RequestParam(value = "courseCode")
                                                int courseCode,
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam(value = "deptCode")
                                              String deptCode,
                                            @RequestParam(value = "courseCode")
                                              int courseCode,
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam(value = "deptCode")
                                                 String deptCode,
                                               @RequestParam(value = "courseCode")
                                                int courseCode,
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam(value = "deptCode")
                                                  String deptCode,
                                                @RequestParam(value = "courseCode")
                                                  int courseCode,
